defmodule GodwokenExplorer.Repo.Migrations.CreateVersions do
  use Ecto.Migration
  ...
  def change do
    create table(:versions) do
      ...
      # for example, it's a good idea to track who did the changedd :user_id, references(:users, on_update: :update_all, on_delete: :nilify_all)
    end
