defmodule GodwokenExplorerWeb.API.RPC.RPCTranslator do
  @moduledoc """
  ...
  @doc false
  @spec translate_module(map(), String.t()) ::
          {:ok, {module(), list(atom())}} | {:error, :no_action}
  ...
  defp action_accessed?(action, write_actions) do
    conf = Application.get_env(:godwoken_explorer, GodwokenExplorerWeb.ApiRouter)
  ...
  @doc false
  @spec call_controller(Conn.t(), module(), atom()) ::
          {:ok, Conn.t()} | {:error, :no_action} | {:error, Exception.t()}
