defmodule GodwokenExplorerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GodwokenExplorerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GodwokenExplorerWeb.Gettext, "errors", msg, opts)
    end
  end
