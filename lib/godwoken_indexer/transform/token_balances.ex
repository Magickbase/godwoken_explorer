defmodule GodwokenIndexer.Transform.TokenBalances do
  ...
  defp reducer({:token_transfers_params, token_transfers_params}, initial) when is_list(token_transfers_params) do
    ...
    |> Enum.reduce(initial, fn %{
        ...
        acc
        |> add_token_balance_address(from_address_hash, token_contract_address_hash, token_id, block_number)
        |> add_token_balance_address(to_address_hash, token_contract_address_hash, token_id, block_number)
    end)
  end
  ...
  defp add_token_balance_address(map_set, address, token_contract_address, token_id, block_number) do
    MapSet.put(map_set, %{
