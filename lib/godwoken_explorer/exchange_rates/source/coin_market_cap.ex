defmodule GodwokenExplorer.ExchangeRates.Source.CoinMarketCap do
  @moduledoc """
  ...
  def format_data(%{"data" => _} = json_data) do
    ...
    btc_value =
      if Application.get_env(:godwoken_explorer, GodwokenExplorer.ExchangeRates)[
           :fetch_btc_value
         ],
  ...
  defp api_key do
    Application.get_env(:godwoken_explorer, ExchangeRates)[:coinmarketcap_api_key]
  end
