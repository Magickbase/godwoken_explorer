defmodule GodwokenExplorer.ExchangeRates do
  @moduledoc """
  ...
  defp fetch_rates do
    Task.Supervisor.async_nolink(GodwokenExplorer.MarketTaskSupervisor, fn ->
  ...
  defp enabled? do
    Application.get_env(:godwoken_explorer, __MODULE__, [])[:enabled] == true
  end
end
