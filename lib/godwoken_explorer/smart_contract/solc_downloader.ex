defmodule GodwokenExplorer.SmartContract.SolcDownloader do
  @moduledoc """
  ...
  defp compiler_dir do
    Application.app_dir(:godwoken_explorer, "priv/solc_compilers/")
  end

  defp download(version) do
    download_path =
      "https://binaries.soliditylang.org/emscripten-wasm32/solc-emscripten-wasm32-#{version}.js"
