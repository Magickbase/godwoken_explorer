...
defmodule GodwokenExplorer.SmartContract.Verifier.ConstructorArguments do
  @moduledoc """
  ...
  defp extract_constructor_arguments(code, check_func, contract_source_code, contract_name) do
    case code do
      ...
      <<_::binary-size(2)>> <>
          ...
          <<_::binary-size(64)>> <>
          @metadata_hash_common_suffix <>
          "43" <> <<_::binary-size(6)>> <> "0032" <> constructor_arguments ->
        split_constructor_arguments_and_extract_check_func(
          constructor_arguments,
          check_func,
          contract_source_code,
      ...
      <<_::binary-size(2)>> <>
          ...
          <<_::binary-size(64)>> <>
          @metadata_hash_common_suffix <>
          "7826" <> <<_::binary-size(76)>> <> "0057" <> constructor_arguments ->
        split_constructor_arguments_and_extract_check_func(
          constructor_arguments,
          check_func,
          contract_source_code,
      ...
      <<_::binary-size(2)>> <>
          ...
          <<_::binary-size(64)>> <>
          @metadata_hash_common_suffix <>
          "7827" <> <<_::binary-size(78)>> <> "0057" <> constructor_arguments ->
        split_constructor_arguments_and_extract_check_func(
          constructor_arguments,
          check_func,
          contract_source_code,
      ...
      @metadata_hash_prefix_0_6_0 <>
          <<_::binary-size(68)>> <>
          @metadata_hash_common_suffix <>
          "43" <> <<_::binary-size(6)>> <> "0033" <> constructor_arguments ->
        split_constructor_arguments_and_extract_check_func(
          constructor_arguments,
          check_func,
          contract_source_code,
  ...
  defp split_constructor_arguments_and_extract_check_func(
    ...
    if is_constructor_arguments_still_has_metadata_prefix(
         constructor_arguments,
         metadata_hash_prefix
       ) do
  ...
  defp extract_constructor_arguments_check_func(
         constructor_arguments,
         check_func,
         contract_source_code,
         contract_name
    ...
    constructor_arguments =
      remove_require_messages_from_constructor_arguments(
        contract_source_code,
        constructor_arguments,
        contract_name
      )
    ...
    filtered_constructor_arguments =
      remove_keccak256_strings_from_constructor_arguments(
        contract_source_code,
        constructor_arguments,
        contract_name
      )
      ...
      true ->
        ...
        if output do
          ...
          clean_constructor_arguments =
            remove_substring_of_require_messages(
              filtered_constructor_arguments,
              contract_source_code,
              contract_name
            )
  ...
  defp remove_substring_of_require_messages(
         constructor_arguments,
         contract_source_code,
         contract_name
       ) do
    ...
    [_, cleaned_constructor_arguments] =
      String.split(constructor_arguments, longest_substring_to_delete, parts: 2)

    cleaned_constructor_arguments
  end

  def remove_require_messages_from_constructor_arguments(
        contract_source_code,
        constructor_arguments,
        contract_name
      ) do
  ...
  def remove_keccak256_strings_from_constructor_arguments(
        contract_source_code,
        constructor_arguments,
        contract_name
      ) do
  ...
  defp parse_constructor_and_return_check_func(abi) do
    constructor_abi =
      Enum.find(abi, fn el -> el["type"] == "constructor" && el["inputs"] != [] end)

    input_types =
      Enum.map(constructor_abi["inputs"], &FunctionSelector.parse_specification_type/1)
