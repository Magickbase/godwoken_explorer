defmodule GodwokenExplorer.Withdrawal do
  ...
  def changeset(withdrawal, attrs) do
    withdrawal
    |> cast(attrs, [:account_script_hash, :amount, :capacity, :owner_lock_hash, :payment_lock_hash, :sell_amount, :sell_capacity, :sudt_script_hash, :udt_id])
    |> validate_required([:account_script_hash, :amount, :capacity, :owner_lock_hash, :payment_lock_hash, :sell_amount, :sell_capacity, :sudt_script_hash, :udt_id])
  end
