defmodule GodwokenExplorer.Counters.AccountsCounter do
  @moduledoc """
  Caches the number of all accounts.
  ...
  # the test env.
  config = Application.compile_env(:godwoken_explorer, GodwokenExplorer.Counters.AccountsCounter)
