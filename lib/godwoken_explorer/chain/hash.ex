defmodule GodwokenExplorer.Chain.Hash do
  @moduledoc """
  ...
  Converts the `t:t/0` to the integer version of the hash
      ...
      iex>GodwokenExplorer.Chain.Hash.to_integer(
      ...>   %Explorer.Chain.Hash{
      ...>     byte_count: 32,
  ...
  Converts the `t:t/0` to `iodata` representation shown to users.
      ...
      ...>            big-integer-size(32)-unit(8)>>
      ...> } |>
      ...>GodwokenExplorer.Chain.Hash.to_iodata() |>
      ...> IO.iodata_to_binary()
      "0x9fc76417374aa880d4449a1f7f31ec597f00b1f6f3dd2d66f4c9c6c445836d8b"
  ...
  Converts the `t:t/0` to string representation shown to users.
      ...
      iex>GodwokenExplorer.Chain.Hash.to_string(
      ...>   %Explorer.Chain.Hash{
      ...>     byte_count: 32,
      ...>     bytes: <<0x9fc76417374aa880d4449a1f7f31ec597f00b1f6f3dd2d66f4c9c6c445836d8b ::
      ...>              big-integer-size(32)-unit(8)>>
