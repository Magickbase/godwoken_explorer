defmodule GodwokenExplorer.Chain.Hash.Full do
  @moduledoc """
  ...
  If the `term` is already in `t:t/0`, then it is returned
      ...
      iex>GodwokenExplorer.Chain.Hash.Full.cast(
      ...>   %Explorer.Chain.Hash{
      ...>     byte_count: 32,
  ...
  If the `term` is an `non_neg_integer`, then it is converted to `t:t/0`
      ...
      iex>GodwokenExplorer.Chain.Hash.Full.cast(0x9fc76417374aa880d4449a1f7f31ec597f00b1f6f3dd2d66f4c9c6c445836d8b)
      {
        :ok,
        %Explorer.Chain.Hash{
          byte_count: 32,
  ...
  If the `non_neg_integer` is too large, then `:error` is returned.
      ...
      iex>GodwokenExplorer.Chain.Hash.Full.cast(0xffff_9fc76417374aa880d4449a1f7f31ec597f00b1f6f3dd2d66f4c9c6c445836d8)
      :error
  ...
  `String.t` format must always have #{@hexadecimal_digit_count} hexadecimal digits after the `0x` base prefix.
      ...
      iex>GodwokenExplorer.Chain.Hash.Full.cast("0x0")
      :error
  ...
  If the field from the struct is `t:t/0`, then it succeeds.
      ...
      iex>GodwokenExplorer.Chain.Hash.Full.dump(
      ...>   %Explorer.Chain.Hash{
      ...>     byte_count: 32,
      ...>     bytes: <<0x9fc76417374aa880d4449a1f7f31ec597f00b1f6f3dd2d66f4c9c6c445836d8b ::
      ...>              big-integer-size(32)-unit(8)>>
  ...
  If the binary hash is the correct format, it is returned
      ...
      iex>GodwokenExplorer.Chain.Hash.Full.load(
