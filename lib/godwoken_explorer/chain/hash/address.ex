defmodule GodwokenExplorer.Chain.Hash.Address do
  @moduledoc """
  ...
  If the `term` is already in `t:t/0`, then it is returned
      ...
      iex>GodwokenExplorer.Chain.Hash.Address.cast(
      ...>   %Explorer.Chain.Hash{
      ...>     byte_count: 20,
  ...
  If the `term` is an `non_neg_integer`, then it is converted to `t:t/0`
      ...
      iex>GodwokenExplorer.Chain.Hash.Address.cast(0x5aAeb6053F3E94C9b9A09f33669435E7Ef1BeAed)
      {
        :ok,
        %Explorer.Chain.Hash{
          byte_count: 20,
  ...
  If the `non_neg_integer` is too large, then `:error` is returned.
      ...
      iex>GodwokenExplorer.Chain.Hash.Address.cast(0x9fc76417374aa880d4449a1f7f31ec597f00b1f6f3dd2d66f4c9c6c445836d8b)
      :error
  ...
  `String.t` format must always have #{@hexadecimal_digit_count} digits after the `0x` base prefix.
      ...
      iex>GodwokenExplorer.Chain.Hash.Address.cast("0x0")
      :error
  ...
  If the field from the struct is `t:t/0`, then it succeeds
      ...
      iex>GodwokenExplorer.Chain.Hash.Address.dump(
      ...>   %Explorer.Chain.Hash{
      ...>     byte_count: 20,
      ...>     bytes: <<0x5aAeb6053F3E94C9b9A09f33669435E7Ef1BeAed :: big-integer-size(20)-unit(8)>>
      ...>   }
  ...
  If the binary hash is the correct format, it is returned.
      ...
      iex>GodwokenExplorer.Chain.Hash.Address.load(
  ...
  * `:invalid_length` - Addresses are expected to be 40 hex characters long
  ...
  ## Example
      ...
      iex>GodwokenExplorer.Chain.Hash.Address.validate("0xc1912fEE45d61C87Cc5EA59DaE31190FFFFf232d")
      {:ok, "0xc1912fEE45d61C87Cc5EA59DaE31190FFFFf232d"}

      iex>GodwokenExplorer.Chain.Hash.Address.validate("0xc1912fEE45d61C87Cc5EA59DaE31190FFFFf232H")
