defmodule GodwokenRPC.Log do
  ...
  @typedoc """
   * `"address"` - `t:GodwokenRPC.address/0` from which event originated.
   * `"blockHash"` - `t:GodwokenRPC.hash/0` of the block this transaction is in.
   * `"blockNumber"` - `t:GodwokenRPC.quantity/0` for the block number this transaction is in.
   * `"data"` - Data containing non-indexed log parameter
   * `"logIndex"` - `t:GodwokenRPC.quantity/0` of the event index positon in the block.
   * `"topics"` - `t:list/0` of at most 4 32-byte topics.  Topic 1-3 contains indexed parameters of the log.
   * `"transactionHash"` - `t:GodwokenRPC.hash/0` of the transaction
   * `"transactionIndex"` - `t:GodwokenRPC.quantity/0` for the index of the transaction in the block.
  """
  ...
  Converts `t:elixir/0` format to params used in `Explorer.Chain`.
      ...
      iex> GodwokenRPC.Log.elixir_to_params(
      ...>   %{
  ...
  Geth and Parity >= 1.11.4 includes a `"removed"` key
      ...
      iex> GodwokenRPC.Log.to_elixir(
      ...>   %{
      ...>     "address" => "0xda8b3276cde6d800000000000000000000000000",
      ...>     "blockHash" => "0x0b89f7f894f5d8ba941e16b61490e999a0fcaaf92dfcc70aee2ac5ddb5f243e1",
      ...>     "blockNumber" => "0x1160",
      ...>     "data" => "0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e563",
      ...>     "logIndex" => "0x0",
